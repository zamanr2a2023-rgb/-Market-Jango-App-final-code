...
class BuyerVendorFollowersScreen extends ConsumerWidget {
  const BuyerVendorFollowersScreen({super.key, required this.vendorId});

  static const String routeName = '/vendor/public-followers';

  final int vendorId;

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final async = ref.watch(publicVendorFollowersProvider(vendorId));
