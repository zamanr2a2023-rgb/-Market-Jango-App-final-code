...
class PublicDriverFollowersScreen extends ConsumerWidget {
  const PublicDriverFollowersScreen({super.key, required this.driverId});

  static const String routeName = '/driver/public-followers';

  final int driverId;

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final async = ref.watch(publicDriverFollowersProvider(driverId));
