...
class VendorFollowersScreen extends ConsumerWidget {
  const VendorFollowersScreen({super.key});

  static const String routeName = '/vendor/followers';

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final async = ref.watch(vendorFollowersProvider);
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                TextButton(
                  onPressed: () => ref.invalidate(vendorFollowersProvider),
